...
use webvimark\modules\UserManagement\models\User;
    ...
    echo Nav::widget([
        ...
        'items' => [
            ...
            ['label' => Yii::t('app', 'Les personnes'), 'url' => ['/personnes'], 'visible' => !Yii::$app->user->isGuest && User::canRoute(['/personnes/index'])],
            ...
            ['label' => Yii::t('app', 'Outils'), 'visible' => !Yii::$app->user->isGuest && User::canRoute(['/clients-online/index']),
                'items' => [
                     ...
                     ['label' => Yii::t('app', 'Heures moniteurs'), 'url' => ['/personnes/moniteurs'], 'visible' => User::canRoute(['/personnes/moniteurs'])],
