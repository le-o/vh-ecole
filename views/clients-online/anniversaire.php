...
<div class="site-index">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <a class="btn btn-info" href="https://ecole.vertic-halle.ch/web/index.php?r=clients-online%2Fcreateanniversaire&free=1&lang_interface=<?= Yii::$app->language ?>"><?= Yii::t('app', 'Horaire au choix') ?></a><br /><br />
        </div>
    </div>
